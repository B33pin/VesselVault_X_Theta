...
const Footer = () => {
  return (
    <footer
      className="py-20 lg:py-28 bg-cover bg-top bg-no-repeat relative"
    ...
    >
      <div className="absolute z-10 hidden xl:block opacity-25 2xl:opacity-100 top-0 bottom-0 right-0 left-0">
        <span className="animate-1 absolute right-32 bottom-40">
          <svg
            width="101"
            height="75"
            viewBox="0 0 101 75"
        ...
        <span className="animate-2 absolute right-20 top-80">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
        ...
        <span className="animate-3 absolute right-16 top-52">
          <svg
            width="60"
            height="59"
            viewBox="0 0 60 59"
        ...
        <span className="animate-2 absolute right-32 top-52">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <rect width="18" height="18" fill="#FEC3C3" />
          </svg>
        </span>
        <span className="animate-1 absolute right-20 top-96">
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="10" cy="10" r="10" fill="#FBCCCC" />
          </svg>
        </span>
        <span className="animate-3 absolute right-72 top-52">
          <svg
            width="93"
            height="75"
            viewBox="0 0 93 75"
        ...
        <span className="animate-2 absolute left-20 top-52">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
        ...
        <span className="animate-3 absolute left-32 top-40">
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <ellipse cx="10.0674" cy="10" rx="10.0674" ry="10" fill="#F7BBBB" />
          </svg>
        </span>
        <span className="animate-1 absolute left-16 top-96">
          <svg
            width="38"
            height="38"
            viewBox="0 0 38 38"
      ...
      <div className="container mx-auto z-20 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="footer-widget">
            <h4 className="text-2xl text-coolGray-900 font-bold">My Account</h4>
            <ul className="footer-menu-list mt-2 lg:mt-5 block">
              <li className="mb-4 mr-4">
                <a
                  className="text-coolGray-600 font-normal transition duration-500 hover:text-red-400 my-4"
                  href="creator.html"
                >
                  Creator Dashboard
                </a>
          ...
          <div className="footer-widget">
            <h4 className="text-2xl text-coolGray-900 font-bold">Web Links</h4>
            <ul className="footer-menu-list mt-2 lg:mt-5 block">
              <li className="mb-4 mr-4">
                <a
                  className="text-coolGray-600 font-normal transition duration-500 hover:text-red-400 my-4"
          ...
          <div className="footer-widget">
            <h4 className="text-2xl text-coolGray-900 font-bold">Community</h4>
            <ul className="footer-menu-list mt-2 lg:mt-5 block">
              <li className="mb-4 mr-4">
                <a
                  className="text-coolGray-600 font-normal transition duration-500 hover:text-red-400 my-4"
          ...
          <div className="footer-widget">
            <h4 className="text-2xl text-coolGray-900 font-bold">Contact</h4>
            <ul className="footer-menu-list mt-2 lg:mt-5 block">
              <li className="mb-4 mr-4">
                <p className="text-coolGray-600 font-normal transition duration-500 hover:text-red-400">
                  {" "}
        ...
        <div className="block lg:grid justify-items-center border-b border-t border-coolGray-300 items-center justify-center py-3 mb-14">
          <div
            className="social-share2 grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4"
            data-aos="fade"
          >
            <a
              className="flex items-center justify-center bg-white rounded-lg border transition duration-200 hover:text-red-600 hover:bg-red-50 px-4 py-2 md:px-6 md:py-3 my-1"
        ...
        <div className="lg:flex justify-between items-center">
          <p className="text-center lg:text-left font-medium">
            &copy; VesselVault -{" "}
            <span id="spanYear">{new Date().getFullYear()}</span> - Built for{" "}
            <a
              className="text-red-600 hover:underline"
              href="https://theta2023.devpost.com"
            >
              Theta Network 2023 Hackathon
            </a>
          </p>
          <ul className="flex items-center justify-center">
            <li>
              <Link
                href="/privacy-policy"
                className="inline-flex leading-3 text-center items-center border-r transition duration-200 hover:text-red-600 pr-2 mb-2"
              >
                Privacy Policy
              </Link>
            </li>
