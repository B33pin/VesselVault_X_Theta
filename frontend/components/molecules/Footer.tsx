  ...
  return (
    ...
    >
      <div className="absolute z-10 hidden xl:block opacity-25 2xl:opacity-100 top-0 bottom-0 right-0 left-0">
        ...
        <span className="animate-3 absolute left-72 top-52">
          <svg
            width="93"
            height="75"
            viewBox="0 0 93 75"
      ...
      <div className="max-w-3xl mx-auto z-20 relative">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="footer-widget">
            <h4 className="text-2xl text-gray-900 font-bold">Contact</h4>
            <ul className="footer-menu-list mt-2 lg:mt-5 block">
              <li className="mb-4 mr-4">
        ...
        <div className="lg:flex justify-between items-center border-t pt-5 gap-10">
          <p className="text-center lg:text-left font-bold text-red-600">
            &copy; VesselVault -{" "}
            <span id="spanYear">{new Date().getFullYear()}</span>
          </p>
