...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await db
        .collection("Contact")
        .create([address, name, email, subject, message]);
  ...
  return (
    <div>
      <Head>
        <title>Contact us | VesselVault</title>
        <meta
          name="description"
          ...
          <div className="max-w-5xl mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16">
              <div className="bg-white shadow-md rounded p-6 lg:p-10">
                ...
                <h2 className="text-xl text-gray-900 font-bold mb-2">Email:</h2>
                <p className="text-gray-600 font-normal mb-6">
              ...
              <div className="bg-white shadow-md rounded p-6 lg:p-10">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    <FormField
                      labelText="Subject *"
                      placeholderText="Write your subject"
                      inputType="text"
                      inputValue={form.subject}
                      handleInputChange={(e) =>
                        handleFormFieldChange("subject", e)
                      }
                    />
                  </div>
                  <div className="mb-4">
                  ...
                  <button
                    type="submit"
                    className={`w-full flex justify-center items-center border border-red-600 text-white rounded-full transition-all duration-500 bg-gradient-to-r from-red-600 via-red-500 to-red-400 hover:from-red-400 hover:via-red-500 hover:to-red-600 bg-left px-8 py-3 mt-5 uppercase ${
