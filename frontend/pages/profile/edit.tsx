              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-wrap lg:gap-4">
                  ...
                  <div className="mb-4 w-full lg:flex-1">
                    <FormField
                      labelText="Email *"
                      placeholderText="john@vesselvault.com"
                      inputType="email"
                ...
                <div className="mb-4">
                  <FormField
                    ...
                    isTextArea
                    inputValue={form.bio}
                    handleInputChange={(e) => handleFormFieldChange("bio", e)}
                  />
                </div>
                <div className="flex flex-wrap lg:gap-4">
                  <div className="mb-4 w-full lg:flex-1">
                ...
                <div className="flex flex-wrap lg:gap-4">
                  ...
                  <div className="mb-4 w-full lg:flex-1">
                    <FormField
                      ...
                      inputType="text"
                      inputValue={form.instagramLink}
                      handleInputChange={(e) =>
                        handleFormFieldChange("instagramLink", e)
                      }
                      error={
                        isValidURL(form.instagramLink)
                          ? ""
